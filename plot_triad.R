...
plot_triad = function(list_in) {
  ...
  par(mfrow=c(3,2), oma=c(0,0,3,0), mar=c(4.5,4,0.5,1))
  ...
  mtext(side=3, line=0, paste0('Monte Carlo Simulation Plots (y = a*x^b + c) [n=', list_in$n,
